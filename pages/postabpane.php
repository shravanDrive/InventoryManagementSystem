                                    ...
                                    <div class="col-sm-4 col-md-2" >
                                      <form method="post" action="pos.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
                                          <div class="products">
                                              ...
                                              <input type="text" name="quantity" onkeyup="check(this,<?php echo $product['PRODUCT_ID']; ?>,<?php echo $product['QTY_STOCK']; ?>)"  class="form-control" />
                                              <input type="hidden" name="name" value="<?php echo $product['NAME']; ?>" />
                                              <input type="hidden" name="price" value="<?php echo $product['PRICE']; ?>" />
                                              <input type="submit" name="addpos" id="<?php echo $product['PRODUCT_ID']; ?>" style="margin-top:5px;" class="btn btn-info"
                                                     value="Add" disabled/>
                                          </div>
                                      </form>
                                  </div>
...
<script>
    function check(txt,idVal, stock) {
      //alert(txt.value);
        var bt = document.getElementById(idVal);
        if (txt.value <= stock) {
            bt.disabled = false;
        }
        else {
