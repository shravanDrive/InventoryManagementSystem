...
$query = 'SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME,GENDER, EMAIL, PHONE_NUMBER, j.JOB_TITLE, HIRED_DATE, l.PROVINCE, l.CITY FROM employee e join location l on l.LOCATION_ID=e.LOCATION_ID join job j on j.JOB_ID=e.JOB_ID WHERE EMPLOYEE_ID =' . $_GET['id'];
$result = mysqli_query($db, $query) or die(mysqli_error($db));
    ...
    <div class="card-body">
      ...
      <form role="form" method="post" action="emp_edit1.php">
        ...
        <div class="form-group row text-left text-warning">
          ...
          <div class="col-sm-9">
            <input placeholder="Hired Date" type="date" id="FromDate" name="hireddate" value="<?php echo $hdate; ?>"
