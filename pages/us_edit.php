  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <form role="form" method="post" action="us_edit1.php">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <select class='form-control' name='gender' required>
                    ...
                    <option value="Male" <?=$c == 'Male' ? ' selected="selected"' : '';?>>Male</option>
                    <option value="Female" <?=$c == 'Male' ? ' selected="selected"' : '';?>>Female</option>
                  </select>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <input type="password" class="form-control" placeholder="Password" name="password" value="<?php echo $e; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
